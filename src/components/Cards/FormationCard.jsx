...
import { FiMapPin, FiDollarSign, FiClock, FiStar, FiHeart } from "react-icons/fi";
      ...
      <div className="card cursor-pointer group overflow-hidden">
        ...
        <div className="p-4 space-y-3">
          <div className="flex items-start justify-between gap-2">
            <h3 className="font-bold text-gray-800 group-hover:text-teal-600 transition line-clamp-2">
              {formation.title}
            </h3>
          </div>
